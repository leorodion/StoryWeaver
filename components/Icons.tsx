...
export const CreditCardIcon: React.FC<IconProps> = ({ className }) => (
    ...
    >
      ...
      <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 18.75h19.5a2.25 2.25 0 002.25-2.25V6.75A2.25 2.25 0 0021.75 4.5H2.25A2.25 2.25 0 000 6.75v9.5A2.25 2.25 0 002.25 18.75z" />
    </svg>
  );
